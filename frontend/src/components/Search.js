...
useEffect(() => {
    ...
    .catch(err => console.log(err, 'things not working in the search barfetch request'))
},[])
...
const handleFilter = (value) => {
    ...
    return (
        ...
        <div className="search">
            <input type="text" placeholder="search monsters here" onChange={ e => handleFilter(e.target.value)}/>
